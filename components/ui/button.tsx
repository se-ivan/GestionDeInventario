  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all cursor-pointer disabled:opacity-50 [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-slate-200 bg-background shadow-xs hover:bg-accent cursor-pointer dark:bg-input/30 dark:border-input dark:hover:bg-input/50",
        minimal:
          "bg-slate-200 shadow-xs hover:bg-slate-300 dark:bg-input/30 dark:border-input cursor-pointer dark:hover:bg-input/50",
        
        secondary:
          "bg-secondary text-secondary-foreground shadow-xs hover:bg-secondary/80 cursor-pointer",
        ghost:
          "hover:bg-accent dark:hover:bg-accent/50 cursor-pointer",
